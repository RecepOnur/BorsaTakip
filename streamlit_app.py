...
start_date = st.sidebar.date_input("Başlangıç Tarihi", value=datetime(2017, 1, 1))
...
st.download_button(label='Excel olarak indir', data=excel_data, file_name=f'{symbol}_data.xlsx', mime='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')